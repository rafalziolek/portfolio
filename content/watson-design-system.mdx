...
![Presentation of font Inter with example glyphs](/projects/watson/font.png)

![List of example texts with sizes from Watson and list of example text with font weights from Watson](/projects/watson/scale.png)

After defining the scale I worked on design tokens that would let us define semantic styles with clear usage.

![List of example texts with sizes from Watson and list of example text with font weights from Watson](/projects/watson/variants.png)
...
![List of example texts with sizes from Watson and list of example text with font weights from Watson](/projects/watson/layouts.png)

![List of example texts with sizes from Watson and list of example text with font weights from Watson](/projects/watson/layouts-explorations.png)

![List of example texts with sizes from Watson and list of example text with font weights from Watson](/projects/watson/screen_1.png)

![List of example texts with sizes from Watson and list of example text with font weights from Watson](/projects/watson/screen_2.png)

![List of example texts with sizes from Watson and list of example text with font weights from Watson](/projects/watson/screen_3.png)

![List of example texts with sizes from Watson and list of example text with font weights from Watson](/projects/watson/screen_4.png)
...
![List of example texts with sizes from Watson and list of example text with font weights from Watson](/projects/watson/components.png)
...
![List of example texts with sizes from Watson and list of example text with font weights from Watson](/projects/watson/docs-1.png)

![List of example texts with sizes from Watson and list of example text with font weights from Watson](/projects/watson/docs-2.png)
