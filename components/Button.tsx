...
const Button: React.FC<ButtonProps> = ({
  ...
  const commonClasses = `flex h-[42px] w-fit min-w-[42px] items-center justify-center gap-0.5 rounded-full px-2.5 text-lg font-medium -tracking-[0.02em] transition-all ease-out hover:bg-neutral-300 active:scale-97 ${variants[variant]} ${className} `;
