...
export default function Home() {
  return (
    <div data-hide-cursor className="align-start flex max-w-[580px] flex-col justify-start p-6">
      <h1 className="font-gyre-heros pb-9 text-[3.375rem] leading-[0.9em] tracking-[-0.03em]">
        I'm a software designer based in Warsaw.
      </h1>
      <div className="flex flex-col pb-10">
        <p className="text-lg leading-[1.4em] tracking-tight">
        ...
        <div className="flex gap-3.5 pt-3">
          <a
            className="text-lg leading-[1.4em] tracking-tight underline decoration-white/40 decoration-dotted decoration-1 underline-offset-4"
          ...
          <a
            className="text-lg leading-[1.4em] tracking-tight underline decoration-white/40 decoration-dotted decoration-1 underline-offset-5"
