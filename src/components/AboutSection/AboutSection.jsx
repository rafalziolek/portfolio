  ...
  return (
    ...
    >
      ...
      <motion.div className={styles.paragraph} variants={paragraphVariants}>
        ...
        <Text tag="p">
          Design for me is not just about making things look good; it's about
          crafting an experience that's intuitive, user-friendly, and above all,
          honest. I aim for transparency, ensuring that what's good for the
          business also benefits the person using it.
        </Text>
        <Text tag="p">
          Beyond the world of UI/UX, I draw inspiration from various disciplines
          and arts, from photography to design as an art form. All these feed
          into a design process that's as versatile as it is focused.
        </Text>
        <Text tag="p">
          Although I am first and foremost a designer, I do experiment with code
          to give my designs an extra layer of polish.
        </Text>
        <Text tag="p">
      ...
      <motion.div className={styles.listGroup} variants={paragraphVariants}>
        <List heading="Who inspires me">
          <List.Item href="https://www.youtube.com/@FaizalWestcott" external>
            Faizal Westcott
          </List.Item>
        ...
        <List heading="Random favs">
          <List.Item href="https://en.wikipedia.org/wiki/Star_Wars" external>
            Star Wars
          </List.Item>
          <List.Item
